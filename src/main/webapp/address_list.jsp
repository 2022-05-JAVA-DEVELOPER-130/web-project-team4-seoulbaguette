						...
						<td>
							...
							<input type="hidden" name="add_no" value="<%=addressList.get(i).getAdd_no()%>"   />
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<input type="button" value="주소록수정" onClick="addressModify('f<%=i%>')">&nbsp; 
									<input type="button" value="주소록삭제" onClick="addressRemove()">&nbsp;
							</form> <br />
							<%} %>
							<table border="0" cellpadding="0" cellspacing="1">
								<tr>
									<td align=center>
									<input type="button" value="돌아가기" onClick="userAddress()">
									</td>
								</tr>
							</table>
						</td>
